...
CND_DLIB_EXT=so
CND_CONF=testListeTrieeChaineeExtensions
CND_DISTDIR=dist
CND_BUILDDIR=build
...
${OBJECTDIR}/testeListeTrieeChaineeExtensions.o: testeListeTrieeChaineeExtensions.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/testeListeTrieeChaineeExtensions.o testeListeTrieeChaineeExtensions.cpp
