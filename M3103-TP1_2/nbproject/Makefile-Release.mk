...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/m3103-tp1_2

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/m3103-tp1_2: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/m3103-tp1_2 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/ListeTrieeChainee.o: ListeTrieeChainee.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListeTrieeChainee.o ListeTrieeChainee.cpp
...
${OBJECTDIR}/testeListeTrieeChainee.o: testeListeTrieeChainee.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/testeListeTrieeChainee.o testeListeTrieeChainee.cpp

${OBJECTDIR}/testeListeTrieeChaineeExtensions.o: testeListeTrieeChaineeExtensions.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/testeListeTrieeChaineeExtensions.o testeListeTrieeChaineeExtensions.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/m3103-tp1_2
