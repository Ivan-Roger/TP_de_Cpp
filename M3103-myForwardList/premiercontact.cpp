...
int main() {
    ...
    forward_list<string> list1 = {"cinq","quatre","trois","deux","un","zéro"};
    ...
    insereInfoAtPosit(list1,0 ,"zéro");
    insereInfoAtPosit(list1,0,"un");
    insereInfoAtPosit(list1,0,"deux");
    insereInfoAtPosit(list1,0,"trois");
    insereInfoAtPosit(list1,0,"quatre");
    insereInfoAtPosit(list1,0,"cinq");
    ...
    insereInfoAtPosit(list1,2,"six_cinq");
    ...
    insereInfoAtPosit(list1,9,"loin");
    ...
    try {
        ...
        insereInfoAtPosit(list1,11,"trop_loin");
    } catch (PrecondVioleeExcep e) {
        cout << "  !!! CA C'EST MAL PASSEE, VOICI POURQUOI ---> " << endl;
        cout << e.what() << endl;
        cout << "  !!! ENFIN ON A QUAND MEME RECUPERER LE COUP !" << endl;
