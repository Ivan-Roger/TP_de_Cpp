...
void testeEstInfoPresentRec() {
    cout << "DEBUT testeEstInfoPresentRec()" << endl << endl;
    ...
    uneListe.afficheGD();
    string tests[] = {"avantZéro", "zéro", "entreUnEtDeux", "trois", "cinq", "six"};
    
    cout << "estInfoPresentRec(\"avantZéro\") = "<< (uneListe.estInfoPresenteRec(tests[0])?"true":"false") << " / attendu false" << endl;
    cout << "estInfoPresentRec(\"zéro\") = "<< (uneListe.estInfoPresenteRec(tests[1])?"true":"false") << " / attendu true" << endl;
    cout << "estInfoPresentRec(\"entreUnEtDeux\") = "<< (uneListe.estInfoPresenteRec(tests[2])?"true":"false") << " / attendu false" << endl;
    cout << "estInfoPresentRec(\"trois\") = "<< (uneListe.estInfoPresenteRec(tests[3])?"true":"false") << " / attendu true" << endl;
    cout << "estInfoPresentRec(\"cinq\") = "<< (uneListe.estInfoPresenteRec(tests[4])?"true":"false") << " / attendu true" << endl;
    cout << "estInfoPresentRec(\"six\") = "<< (uneListe.estInfoPresenteRec(tests[5])?"true":"false") << " / attendu false" << endl;

    cout << endl << "FIN testeEstInfoPresentRec()" << endl << endl;
}
