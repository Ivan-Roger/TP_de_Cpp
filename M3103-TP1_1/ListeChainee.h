...
private:
    ...
    bool estInfoPresenteRecWorker(Cellule<TypeInfo>* ptrListe, TypeInfo& info);
...
public:
    ...
    // Test de l'existence d'une info dans une liste ; retourne true si trouvé, false sinon
    bool estInfoPresenteRec(TypeInfo& info);
