...
public:
    ...
    void afficheRangedEntriesForm(unsigned int inf = 0, unsigned int sup = numeric_limits<unsigned int>::max());
    ...
    void const debugPrint(tinyxml2::XMLElement* entry) const;
