...
${OBJECTDIR}/ArbreNoeudsBinairesRecherche.o: ArbreNoeudsBinairesRecherche.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ArbreNoeudsBinairesRecherche.o ArbreNoeudsBinairesRecherche.cpp

${OBJECTDIR}/ExceptionPreconditionViolee.o: ExceptionPreconditionViolee.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExceptionPreconditionViolee.o ExceptionPreconditionViolee.cpp

${OBJECTDIR}/NoeudBinaire.o: NoeudBinaire.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NoeudBinaire.o NoeudBinaire.cpp

${OBJECTDIR}/testeArbreNœudBinaireRecherche.o: testeArbreNœudBinaireRecherche.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/testeArbreNœudBinaireRecherche.o testeArbreNœudBinaireRecherche.cpp
